...
module.exports = {
  ...
  run: async (client, message, args, embed, prefix) => { 
    ...
    if(!uye) return message.channel.send(`Hata yaptın!\`${prefix}isim <@Riarny/ID> <Isim> <Yaş>\``);
    ...
    if(!isim || !yaş) return message.channel.send(`Hata yaptın! \`${prefix}isim <@Riarny/ID> <Isim> <Yaş>\``);
